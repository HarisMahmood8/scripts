...
if __name__ == "__main__":
    ...
    unique_cases_data = [(tc.name, tc.environment, tc.case_data) for tc in unique_cases]
    unique_cases_df = pd.DataFrame(unique_cases_data, columns=['Name', 'Environment', 'Case Data'])
    unique_cases_df.to_csv("./Unique_Test_Cases.csv", index=False)
    print("Unique Test Cases saved to Unique_Test_Cases.csv")
